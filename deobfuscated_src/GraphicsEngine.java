...
public final class GraphicsEngine {
    ...
    public final void update_0(byte[] byArray, int n) {
        int n2;
        int n3;
        int n4;
        int n5;
    ...
    public final void update_0(int n, int n2, int n3, int n4, int n5, int n6) {
        Object object;
        int n7;
        Object object2;
        this.d[n] = n6;
        ...
        if (n4 >= 0) {
            ...
            if (n5 >= 0) {
                ...
                for (int i = 0; i < this.c.length; ++i) {
                    ...
                    this.update_0(n9, n, n6);
                }
            } else {
                for (int i = n2; i <= n3; ++i) {
                    this.update_0(i, n, n6);
                }
            }
            this.i = n8;
        }
    ...
    public final void update_0(int n, int n2, int n3) {
    ...
    public final void update_0(int n, byte[] byArray) {
        int n2;
        this.d |= 1 << n;
        if (byArray == null) {
            return;
    ...
    public final int update_0(int n, int n2) {
        return this.g[this.h[n] + n2] & 0xFF;
    }

    public final int update_0(int n) {
        return this.e[n] & 0xFF;
    }

    public final int update_1(int n) {
        return this.b[n] & 0xFF;
    }

    public final int update_1(int n, int n2) {
        int n3 = this.h[n] + n2;
        int n4 = this.f[n3] & 0xFF;
        return n4 |= (this.h[n3] & 0xC0) << 2;
    }

    public final void update_0(int[] nArray, int n, int n2, int n3, int n4, int n5) {
        m = 102400;
        GraphicsEngine.n = 102400;
        o = -102400;
        p = -102400;
        l = 1;
        this.update_0(n, n2, n3, n4, n5);
        l = 0;
        nArray[0] = m;
    ...
    public final void update_0(int[] nArray, int n, int n2, int n3, int n4) {
        m = 0x1900000;
        GraphicsEngine.n = 0x1900000;
        o = -26214400;
        p = -26214400;
        l = 1;
        this.update_0(n, n2, n3, n4);
        l = 0;
        nArray[0] = m;
        nArray[1] = GraphicsEngine.n;
        nArray[2] = o;
    ...
    public final void update_1(int[] nArray, int n, int n2, int n3, int n4, int n5) {
        m = 102400;
        GraphicsEngine.n = 102400;
        o = -102400;
        p = -102400;
        l = 1;
        this.update_1(n, n2, n3, n4, n5);
        l = 0;
        nArray[0] = m;
        nArray[1] = GraphicsEngine.n;
        nArray[2] = o;
    ...
    public final void update_1(int[] nArray, int n, int n2, int n3, int n4) {
        m = 102400;
        GraphicsEngine.n = 102400;
        o = -102400;
        p = -102400;
        l = 1;
        this.update_1(n, n2, n3, n4);
        l = 0;
        nArray[0] = m;
        nArray[1] = GraphicsEngine.n;
        nArray[2] = o;
    ...
    public static void update_0(Graphics graphics) {
        a = graphics;
    }

    public static Graphics update_0() {
        return a;
    }

    public final void update_0(Graphics graphics, int n, int n2, int n3, int n4, int n5) {
        GraphicsEngine.update_0(graphics);
        this.update_0(n, n2, n3, n4, n5);
    }

    public final void update_0(Graphics graphics, int n, int n2, int n3, int n4) {
        GraphicsEngine.update_0(graphics);
        this.update_0(n, n2, n3, n4);
    }

    public final void update_5(int[] nArray, int n, int n2, int n3, int n4, int n5) {
        this.update_0(nArray, n, n2, n3, n4, n5);
    }

    public final void update_5(int[] nArray, int n, int n2, int n3, int n4) {
        this.update_0(nArray, n, n2, n3, n4);
    }

    public final byte[] update_0(int n, int n2) {
     ...
     */
    public final void update_0(int var1_1, int var2_2, int var3_3, int var4_4, int var5_5) {
        block5: {
            block3: {
                block4: {
...
lbl18:
        ...
        if ((GameCanvas.ag & 32) != 0) {
            GameCanvas.update_0(this, var7_7, var3_3, var4_4, var5_5 ^ this.h[var6_6] & 15);
            return;
        }
        this.update_0(var7_7, var3_3, var4_4, var5_5 ^ this.h[var6_6] & 15);
    }

    public final void update_0(int n, int n2, int n3, int n4) {
        int n5 = this.b[n] & 0xFF;
        for (int i = 0; i < n5; ++i) {
            this.update_1(n, i, n2, n3, n4);
        }
    }

    public final void update_1(int n, int n2, int n3, int n4, int n5) {
        int n6;
        int n7;
        block19: {
            int n8;
                                    ...
                                    block15: {
                                        block13: {
                                            ...
                                            if ((this.d[this.i] & 4) != 0 && (GameCanvas.ag & 1) != 0) {
                                                int n16 = GameCanvas.update_1() - 100;
                                                n14 += n16 * n14 / 100 >> 1;
                                                n15 += n16 * n15 / 100 >> 1;
                                            }
                                            if ((n5 & 4) != 0) {
        ...
        if ((n7 & 0x10) != 0) {
            this.update_0(n6, n3, n4, n5 ^ n7 & 0xF);
            return;
        }
        this.update_1(n6, n3, n4, n5 ^ n7 & 0xF);
    }

    public final void update_1(int n, int n2, int n3, int n4) {
        int n5;
        int n6;
        block43: {
            block45: {
        ...
        if (this.k[n] != 0) {
            ...
            if (this.k[n] != 1) {
                if ((GameCanvas.ag & 0x40) != 0) {
                    GameCanvas.update_1(a, this.e[n], n2, n3, n6, n5);
            ...
            if ((GameCanvas.ag & 4) != 0) {
                GameCanvas.update_0(a, this.e[n], n2, n3, n6, n5);
            }
            return;
        }
        Image image = null;
        ...
        if ((this.d[this.i] & 2) != 0) {
            ...
            if ((n14 & 1) != 0) {
                nArray = GameCanvas.update_0(nArray, n6, n5);
                int n15 = GameCanvas.update_1();
                n6 = n6 * n15 / 100;
                n5 = n5 * n15 / 100;
            }
            if ((n14 & 2) != 0) {
                nArray = GameCanvas.update_1(nArray, n6, n5);
                this.a = true;
            }
        }
        if (image == null && nArray == null) {
            int[] nArray2 = this.update_0(n);
            if (nArray2 == null) {
                return;
            }
        ...
        if (l == 0) {
            if (image != null) {
                if ((GameCanvas.ag & 0x80) != 0) {
                    GameCanvas.update_0(a, image, n2, n3);
                } else if ((n4 & 7) == 0) {
                ...
                if ((GameCanvas.ag & 0x80) != 0) {
                    GameCanvas.update_0(a, nArray, n6, n5, n2, n3);
                } else if ((GameCanvas.ag & 0x18) != 0) {
                    try {
                        GameCanvas.update_0(a, n2, n3, nArray, n6, n5, n4);
                    }
                    catch (Exception exception) {}
                } else {
                    nArray = GameCanvas.update_0(a, nArray, n2, n3, n6, n5, n4, this.a);
                }
            }
        }
        if ((this.d[this.i] & 4) != 0 && (GameCanvas.ag & 4) != 0) {
            ...
            GameCanvas.update_0(a, n2, n3, nArray, n6, n5);
        }
    }

    private int[] update_0(int n) {
        int[] nArray;
        block17: {
            int[] nArray2;
            int n2;
    ...
    public final int update_0() {
        return this.d[0] & 0xFF;
    }

    public final void update_0(int n) {
        if (n < this.g) {
            this.i = n;
        }
    }
