...
implements DataListener {
    ...
    public static boolean initSensor() {
        return true;
    }

    public static boolean update_2a84() {
        return a;
    }

    public static void initSensor(boolean bl) {
        a = bl;
        GameCanvas.check_9730();
    }
    ...
    public static boolean check_9730() {
        if (!a) {
            return false;
        }
        if (c > 4) {
