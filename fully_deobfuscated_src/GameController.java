...
CommandListener {
    ...
    private static boolean loadIGPData() {
        GameController.method_9b6e();
        try {
    ...
    private static void method_9b6e() {
        a = null;
        a = null;
        x = 0;
        System.gc();
    ...
    private static byte[] method_9b6e(int n) {
        if (n < 0 || n >= x - 1) {
            return null;
        }
        int n2 = a[n + 1] - a[n];
    ...
    private static int method_9b6e(byte[] byArray) {
        return (byArray[y++] & 0xFF) + ((byArray[y++] & 0xFF) << 8);
    }

    private static Image method_9b6e(byte[] byArray) {
        int n = GameController.method_9b6e(byArray);
        Image image = GameController.method_9b6e(byArray, y, n);
        y += n;
        return image;
    }

    private static Image method_9b6e(byte[] byArray, int n, int n2) {
        if (GameConfig.d) {
    ...
    private static String method_9b6e(int n) {
        return "" + f[n];
    }

    private static int method_9b6e(int n, int n2) {
        if (ap != 0) {
            if (n2 == A || n2 == B) {
    ...
    private static void method_9b6e(int n, Graphics graphics, int n2, int n3, int n4) {
        GameController.method_9b6e(GameController.method_9b6e(n), graphics, ak, n2, n3, n4);
    }

    private static void method_9b6e(String string, Graphics graphics, int n, int n2, int n3, int n4) {
        GameController.method_9b6e(string, graphics, n2, n3, n4);
    }

    /*
     * Unable to fully structure code
     */
    private static void method_9b6e(String var0, Graphics var1_1, int var2_2, int var3_3, int var4_4) {
        block17: {
            block20: {
                block19: {
                    block18: {
                        ...
                        for (var8_11 = 0; var8_11 < var11_9; ++var8_11) {
                            ...
                            if (var7_12 == '\n' && var6_6 < 10 || var7_12 == '\\' && var5_5.charAt(++var8_11) == 'N') {
                                ...
                                v2 = v4;
                                v1 = GameController.b;
                                v3 = GameController.b[v4] + (GameController.method_9b6e(var7_12, GameController.C) + -1);
                            }
                            v1[v2] = v3;
                        }
                        v5 = var6_6;
            ...
            var9_7 = true;
            var10_8 = false;
            GameController.loadIGPData(var1_1, 0, 0, GameController.ak, GameController.al);
            for (var8_11 = 0; var8_11 < var11_9; ++var8_11) {
                block21: {
                    block24: {
                        block23: {
                ...
                if (var14_14 == ' ') {
                    var13_13 -= GameController.method_9b6e(var14_14, GameController.C) + -1 >> 1;
                }
                if (var7_12 == ' ') {
                    v10 = var13_13;
...

                {
                    ...
                    v10 = var13_13;
                    v11 = GameController.method_9b6e(var7_12, GameController.C) + -1;
                }
                var13_13 = v10 + v11;
            }
            GameController.loadIGPData(var1_1, 0, 0, GameController.ak, GameController.al);
    ...
    public static void method_9b6e(MIDlet mIDlet, Canvas canvas, int n, int n2) {
        GameController.method_9b6e(mIDlet, canvas, n, n2, null);
    }

    private static void method_9b6e(MIDlet mIDlet, Canvas canvas, int n, int n2, CommandListener commandListener) {
        ak = n;
        al = n2;
        am = ak >> 1;
        an = al >> 1;
    ...
    private static String method_9b6e(String string, String string2, String string3) {
        String string4 = "";
        try {
    ...
    private static void method_9b6e(int n, String string, int n2, String string2, String string3) {
        try {
            String string4 = null;
            string4 = e ? GameController.method_9b6e(GameController.method_9b6e(string2), string, string3) : GameController.method_9b6e("URL-" + string);
            boolean bl = GameController.method_9b6e(string4, n2);
     ...
     * Unable to fully structure code
     */
    private static void method_9b6e(int var0, String[] var1_1, int var2_2, String var3_3) {
        ...
        if (GameController.e) {
            try {
                var3_3 = GameController.method_9b6e(var3_3);
                if (var0 != 2) {
                ...
                block16: {
                    block14: {
                        ...
                        if (GameController.j.length() > 0) {
                            v2 = GameController.method_9b6e(GameController.method_9b6e("IGP-CATEGORIES"), var1_1[var7_7], GameController.j + "&ctg=XXXX");
                        }
                        break block16;
                    }
                    if (GameController.e) {
...
lbl35:
                ...
                if (!GameController.method_9b6e(var8_8, 7)) continue;
    ...
    private static String[] method_9b6e(byte[] byArray) {
        String[] stringArray = new String[GameController.method_9b6e(byArray)];
    ...
    private static void method_9b6e(String[] stringArray) {
    ...
    private static void loadIGPData() {
        block57: {
            block59: {
                block58: {
                    block50: {
                        ...
                        int n2;
                        try {
                            n2 = GameController.loadIGPData();
                            if (n2 == 0) {
                                m = false;
                                return;
                            }
                            byte[] byArray = GameController.method_9b6e(0);
                            GameController.method_9b6e(byArray);
                            a = GameController.method_9b6e(byArray);
                            stringArray = GameController.method_9b6e(byArray);
                            c = GameController.method_9b6e(byArray);
                            d = GameController.method_9b6e(byArray);
                            e = GameController.method_9b6e(byArray);
                            a = GameController.method_9b6e(byArray) == 1;
                            b = GameController.method_9b6e(byArray) == 1;
                            try {
                                n = GameController.method_9b6e(byArray);
                        ...
                        GameController.method_9b6e(stringArray);
                        ...
                        if (GameConfig.j) {
                            ...
                            try {
                                String string = GameController.method_9b6e("URL-ORANGE");
                        ...
                        String string = null;
                        try {
                            string = GameController.method_9b6e("URL-OPERATOR");
                            if (GameController.method_9b6e(string, 7)) {
                                j = string;
                            }
                            String string2 = GameController.method_9b6e("URL-PT");
                            n = 0;
                            int n4 = 0;
                    ...
                    if (!c) {
                        if (e) {
                            if (GameController.method_9b6e(j, 7)) {
                                GameController.method_9b6e(H, "PROMO", 7, "IGP-CATEGORIES", j + "&ctg=XXXX");
                            }
                        } else {
                            String string = GameController.method_9b6e("URL-PROMO");
                            if (string != null) {
                                string.trim();
                                if (GameController.method_9b6e(GameController.method_9b6e("URL-PROMO"), 7)) {
                    ...
                    GameController.method_9b6e(0, c, t, "IGP-WN");
                    GameController.method_9b6e(1, d, u, "IGP-BS");
                    if (c) break block57;
                    if (!e) break block58;
                    if (!GameController.method_9b6e(GameController.method_9b6e(GameController.method_9b6e("IGP-CATEGORIES"), "OP", j), 7)) break block57;
                    GameController.g[6] = j;
                    if (!GameController.method_9b6e(j, 7)) break block57;
                    break block59;
                }
                if (!GameController.method_9b6e(j, 7)) break block57;
                GameController.g[6] = j;
        ...
        try {
            ...
            k = null;
            if (!e) {
                string = GameController.method_9b6e("URL-GLIVE").trim();
            } else if (GameController.method_9b6e(j, 7)) {
                string = k = GameController.method_9b6e(GameController.method_9b6e("IGP-CATEGORIES"), "GLIVE", j + "&ctg=XXXX");
            }
            if (GameController.method_9b6e(k, 7) && b) {
        ...
        ac = GameController.loadIGPData();
        if (ac > 0) {
            m = true;
        }
    }

    public static int method_9b6e() {
        if (!m) {
            return -1;
        }
        if (a[8]) {
            if (GameController.loadIGPData() > 1) {
                return 2;
            }
            return 1;
        }
        if (GameController.loadIGPData() > 0) {
            return 0;
        }
        return -1;
    }

    public static boolean method_9b6e() {
        return GameController.method_9b6e() != -1;
    }

    public static void method_9b6e(String string, int n) {
        block6: {
            int n2;
            block5: {
                block4: {
                    GameController.loadIGPData(string, n);
        ...
        O = GameController.isOnline();
        if (k) {
            a.setCommandListener((CommandListener)a);
        }
    }

    private static void loadIGPData(String string, int n) {
        if (n < 0 || n >= a.length) {
            return;
        }
        aj = n <= a.length ? n : 0;
    ...
    private static int loadIGPData() {
        int n = 0;
    ...
    private static int loadIGPData(int n, int n2) {
        if (n <= n2 - 1) {
            return n - 1;
        }
        if (n > I + n2 + 1 - 1) {
    ...
    private static void method_9b6e(int n) {
        byte[] byArray = null;
        y = 0;
        int n2 = GameController.loadIGPData(n, 5);
        int n3 = n - 1;
        int n4 = n - 5;
        if (n4 > 0 && n < I + 4) {
            if (n == 0 && !a[n4]) {
        ...
        switch (n2) {
            ...
            case 1: {
                int n5;
                int n6;
                byArray = GameController.method_9b6e(n3);
                for (n6 = 0; n6 < aj; ++n6) {
                    n5 = GameController.method_9b6e(byArray);
                    y += n5;
                }
                GameController.method_9b6e(byArray);
                n5 = GameController.method_9b6e(byArray);
                ...
                if (!k) break;
                a = new Command(GameController.method_9b6e(j), 4, 1);
                b = new Command(GameController.method_9b6e(k), 2, 1);
                GameController.method_9b6e(true, true);
                return;
            }
            case 2: {
                Image image;
                ...
                a = new Image[2];
                byArray = GameController.method_9b6e(n3);
                int n12 = GameController.method_9b6e(byArray);
                y = 0;
                GameController.a[0] = GameController.method_9b6e(byArray);
                if (GameConfig.b) {
                    imageArray = a;
                    n11 = 1;
                    image = GameController.loadIGPData(byArray, 2, n12, 1, 0xFF0000);
                } else {
                    imageArray = a;
                    n11 = 1;
                    image = a[0];
                ...
                int n13 = GameController.method_9b6e(byArray);
                int n14 = GameController.method_9b6e(byArray);
                a = new byte[(n14 + 1) * (4 + ap)];
                int n15 = n13 / (6 + ap);
                for (int i = 0; i < n15; ++i) {
                    int n16 = GameController.method_9b6e(byArray);
            ...
            case 3: {
                ...
                for (int i = 0; i < w; ++i) {
                    ...
                    GameController.b[i] = GameController.method_9b6e(byArray);
                }
                if (c == null) break;
            ...
            default: {
                ...
                y = n17;
                x = n18;
                GameController.method_9b6e(n2, n3, n4);
            }
        }
    }
     ...
     * Unable to fully structure code
     */
    private static void method_9b6e(int var0, int var1_1, int var2_2) {
        var3_3 = null;
        var4_4 = 0;
        var5_5 = 0;
        switch (var0) {
            ...
            case 6: {
                v0 = GameController.c;
                v1 = var2_2;
                v2 = GameController.method_9b6e(GameController.method_9b6e(var1_1));
                ** GOTO lbl59
            }
            case 5: {
                var3_3 = GameController.method_9b6e(var1_1);
                GameController.e = GameController.method_9b6e(var3_3);
                return;
            }
            case 7: {
            ...
            case 8: {
                ...
                for (var6_6 = 0; var6_6 < var5_5; ++var6_6) {
                    GameController.a[var4_4][var6_6] = GameController.method_9b6e(var3_3);
                }
            ...
            case 10: {
                ...
                var3_3 = GameController.method_9b6e(var7_7);
                GameController.c[var2_2] = GameController.method_9b6e(var3_3);
                GameController.d = GameController.method_9b6e(var3_3);
                return;
            }
            case 11: {
                var7_8 = GameController.x - 1 - (GameController.a != false ? 2 : 1);
                var3_3 = GameController.method_9b6e(var7_8);
                GameController.a = GameController.method_9b6e(var3_3);
                var3_3 = GameController.method_9b6e(4 + GameController.H);
                v0 = GameController.c;
                v1 = 8;
                v3 = var3_3;
                v4 = 2;
...
lbl59:
    ...
    private static void loadIGPData(boolean bl) {
        int n;
        e = null;
    ...
    public static void method_9b6e(boolean bl) {
        if (bl) {
            if (M == 0 || M == 2) {
                P = M;
                M = 5;
    ...
    private static int method_9b6e(byte[] byArray, int n, int n2, String string) {
    ...
    private static Image method_9b6e(byte[] byArray, int n, int n2, int n3, int n4) {
        int n5;
        ...
        n5 = GameController.method_9b6e(byArray, n, n2, "PLTE");
        int n7 = GameController.method_9b6e(byArray, n, n2, "tRNS");
        Image image = null;
        if (n5 > 0 && n7 > 0) {
            long l;
            int n8;
            ...
            for (n11 = 0; n11 < n12 / 3; ++n11) {
                ...
                nArray[n6] = n11;
                n10 = GameController.method_9b6e(byArray, n5 + 4 + 3 * n11, 3);
                GameController.method_9b6e(byArray, n5 + 4 + 3 * n11, 3, n4);
                nArray2[n6] = n10;
                ++n6;
            }
            ...
            n9 = GameController.method_9b6e(byArray, n5 + 4 + n12, 4);
            GameController.method_9b6e(byArray, n5 + 4 + n12, 4, (int)(l ^= 0xFFFFFFFFL));
            System.gc();
            if (GameConfig.d) {
            ...
            for (int i = 0; i < n6; ++i) {
                int n13 = nArray[i];
                int n14 = nArray2[i];
                GameController.method_9b6e(byArray, n5 + 4 + 3 * n13, 3, n14);
            }
            GameController.method_9b6e(byArray, n5 + 4 + n12, 4, n9);
        }
        return image;
    }

    private static void method_9b6e(byte[] byArray, int n, int n2, int n3) {
        for (int i = n2 - 1; i >= 0; --i) {
            byArray[n + n2 - 1 - i] = (byte)((n3 & 255 << 8 * i) >> 8 * i);
        }
    }

    private static int method_9b6e(byte[] byArray, int n, int n2) {
        int n3 = 0;
        for (int i = n2 - 1; i >= 0; --i) {
     ...
     * Unable to fully structure code
     */
    public static boolean method_9b6e(int var0) {
        if (!GameController.m) {
            return true;
        }
        ...
        switch (GameController.M) {
            case 0: {
                if (GameController.Q >= GameController.R) {
                    ...
                    GameController.method_9b6e(GameConfig.b != 0 && GameController.Q == 6 ? GameController.I + 5 - 1 : GameController.Q);
                }
                ++GameController.Q;
                break;
            }
...
lbl85:
            ...
            case 2: {
                GameController.loadIGPData(false);
                if (GameConfig.b == 1) {
                    GameController.loadIGPData();
                }
                GameController.Q = 5 + GameController.O;
                GameController.method_9b6e(GameController.Q);
            ...
            case 4: {
                GameController.loadIGPData(true);
                if (GameController.k) {
                    GameController.a.setCommandListener(GameController.a);
                    GameController.update_cee2();
                }
     ...
     * Unable to fully structure code
     */
    public static void method_9b6e(Graphics var0) {
        if (!GameController.m) {
            return;
        }
        ...
        var1_1 = var0;
        GameController.loadIGPData(var0, 0, 0, GameController.ak, GameController.al);
        GameController.loadIGPData(var1_1, 0, 0, GameController.ak, GameController.al);
        switch (GameController.M) {
            case 0: {
                var0.setColor(0);
                var0.fillRect(0, 0, GameController.ak, GameController.al);
                GameController.method_9b6e(var0, GameController.an, GameController.ak * 3 / 4, GameController.Q, GameController.R);
            ...
            case 1: {
                ...
                if (GameController.O == 8) {
                    ...
                    GameController.method_9b6e(var1_1, 0, 0, GameController.ak, GameController.al, var2_2, var3_3);
                }
                GameController.draw_de07(var1_1);
                if (!GameController.o) ** GOTO lbl47
                GameController.loadIGPData(var1_1);
                ** GOTO lbl176
lbl47:
                // 1 sources
                ...
                GameController.method_9b6e(v1, v2, v3, v4, v5);
                GameController.d = true;
                GameController.method_9b6e(GameController.f, null, 0, 0, 0);
                ...
                v7 = GameController.method_9b6e(GameController.g);
                v8 = var1_1;
...
lbl80:
                ...
                GameController.method_9b6e(var1_1, GameController.c[GameController.O], GameController.am, 2, 17);
                ** GOTO lbl176
lbl84:
                // 1 sources
                ...
                if (var4_4 != 0) {
                    GameController.method_9b6e(var1_1, GameController.b[10], GameController.am, GameController.c, 17);
                }
                var12_21 = var11_18 + var6_7;
                var12_21 = var5_6 != 0 ? var12_21 + GameController.e.getHeight() / 2 : GameController.al / 2;
                GameController.method_9b6e(var1_1, GameController.e, GameController.am - 1, var12_21, 3);
                GameController.method_9b6e(GameController.method_9b6e(GameController.ad), var1_1, GameController.e.getWidth() * 9 / 20, GameController.am + 2, var12_21, 3);
...
lbl111:
                ...
                if (GameController.O == 6) {
                    ...
                    GameController.method_9b6e(var1_1, GameController.c[GameController.O], GameController.am, var10_15, 3);
                    var11_19 = GameController.E;
                    GameController.E = 1;
                    GameController.method_9b6e(GameController.method_9b6e(GameController.ad), var1_1, GameController.c[GameController.O].getWidth() / 2, GameController.am, var10_15, 3);
                    ...
                    if (GameController.O == 8) {
                        ...
                        var6_7 = 0;
                        GameController.d = true;
                        GameController.method_9b6e(GameController.method_9b6e(GameController.p), var1_1, GameController.ak - 50, GameController.am, 0, 17);
                        var7_8 = GameController.F;
                        GameController.d = true;
                        GameController.method_9b6e(GameController.method_9b6e(GameController.q), var1_1, GameController.ak - 50, GameController.am, 0, 17);
                        var8_9 = GameController.F;
                        var9_12 = GameController.al - var4_4 - GameController.ag - var7_8 - var8_9 - var5_6;
                        var10_16 = var9_12 / 6;
                        GameController.method_9b6e(var1_1, GameController.a, GameController.am, 0, 17);
                        var6_7 = 0 + (var4_4 + var10_16);
                        GameController.E = 0;
                        GameController.method_9b6e(GameController.method_9b6e(GameController.p), var1_1, GameController.ak * 3 / 4, GameController.am, var6_7, 17);
                        GameController.method_9b6e(var1_1, GameController.c[8], GameController.am - 1, var6_7 += var7_8 + var10_16, 17);
                        GameController.method_9b6e(GameController.method_9b6e(GameController.r), var1_1, GameController.ak * 3 / 4, GameController.am, var6_7 + var5_6 / 2, 3);
                        v7 = GameController.method_9b6e(GameController.q);
                        v8 = var1_1;
                        ...
                        var10_17 = var8_9;
                        GameController.method_9b6e(var1_1, GameController.c[GameController.O], GameController.am, var10_17, 17);
                        ...
                        v7 = GameController.method_9b6e(GameController.ad);
                        v8 = var1_1;
                        v9 = var11_20;
                        v10 = GameController.am;
                        v12 = var9_13;
...
lbl176:
                ...
                if (GameController.ac > 1) {
                    ...
                    GameController.method_9b6e(var1_1, GameController.b[var5_6], 1 + var4_4, GameController.an, 6);
                    if (!GameConfig.h && !GameConfig.k) {
                        GameController.method_9b6e(var1_1, GameController.b[var7_8], 1 + var4_4 + GameController.J, GameController.an, 6);
                    }
                    GameController.method_9b6e(var1_1, GameController.b[var6_7], GameController.ak - 1 - var4_4, GameController.an, 10);
                    if (!GameConfig.h && !GameConfig.k) {
                        GameController.method_9b6e(var1_1, GameController.b[var8_9], GameController.ak - 1 - var4_4 - (GameController.b[var6_7].getWidth() - GameController.b[var8_9].getWidth()) + GameController.K, GameController.an, 10);
                    }
            ...
            case 3: {
                GameController.method_9b6e(var0, 0, 0, GameController.ak, GameController.al, 201756, 35031);
                GameController.method_9b6e(GameController.s, var0, GameController.am, GameController.an, 33);
                GameController.draw_de07(var0);
            }
        }
    }

    private static void loadIGPData(Graphics graphics) {
        int n;
        int n2;
        int n3;
        int n4;
        int n5 = c;
        if (al > 128) {
            GameController.method_9b6e(graphics, c[O], am, c, 17);
            n5 += c[O].getHeight();
        }
        int n6 = n5;
        E = 1;
        GameController.method_9b6e(ad, graphics, am, n6, 17);
        int n7 = Math.max(2 * z, a[S][a[S][0]].getHeight());
        d = true;
        GameController.method_9b6e(ad, null, 0, 0, 0);
        int n8 = n6 + F;
        int n9 = n4 = al * 5 / 100;
        int n10 = (al / 2 - n8) * 2;
        ...
        if (U < T) {
            if (V > 0) {
                GameController.method_9b6e(graphics, am, n12 - n9, n4, 65535, true, false);
            }
            if (V + U < T) {
                GameController.method_9b6e(graphics, am, n12 + U * n7 + n9, n4, 65535, true, true);
            }
        }
        n12 = n8 + n7 / 2 + 1;
        ...
        for (int i = V; i < V + U; ++i) {
            int n16 = a[S][i];
            GameController.method_9b6e(graphics, a[S][n16], n13, n12, 6);
            if (S == 2 || n16 == b[S].length - 1) {
                E = 1;
            }
            GameController.method_9b6e(GameController.method_9b6e(b[S][n16]), graphics, n15, n12, 6);
            n12 += n7;
        }
        X = W - V;
        Y = n13 - 2;
    ...
    private static void method_9b6e(Graphics graphics, int n, int n2, int n3, int n4, boolean bl, boolean bl2) {
        int n5;
        int n6;
        int n7;
        int n8;
        ...
        GameController.loadIGPData(graphics3, n18, n17, n16, n15, n14, n13 + n12);
        ...
        GameController.loadIGPData(graphics2, n11, n10, n9, n8, n7, n6 - n5);
    }

    /*
     * Unable to fully structure code
     */
    private static void draw_de07() {
        GameController.d = true;
        GameController.method_9b6e(GameController.ae, null, 0, 0, 3);
        var0 = GameController.method_9b6e(32, GameController.C) / 2;
        var1_1 = GameController.method_9b6e(32, GameController.D) / 3;
...
lbl16:
    ...
    private static void isOnline(Graphics graphics) {
        if (n) {
            graphics.setColor(a);
            if (GameConfig.j) {
            ...
            GameController.method_9b6e(ae, graphics, am, ai + (ag >> 1), 3);
        }
    }
     ...
     * Unable to fully structure code
     */
    private static void draw_de07(Graphics var0) {
        block15: {
            block16: {
                block14: {
                    block11: {
...
lbl-1000:
                        ...
                        GameController.method_9b6e(var0, var5_5, var1_1, var2_2, 36);
                        GameController.method_9b6e(var0, var6_6, GameController.ak - var1_1, var2_2, 40);
                    ...
                    if ((GameController.a & 1) != 0) {
                        GameController.method_9b6e(var0, GameController.b[9], var3_3, var2_2, 36);
                    }
                ...
                if ((GameController.a & 2) != 0) {
                    GameController.method_9b6e(var0, GameController.b[8], var3_3, var2_2, 36);
                }
            ...
            GameController.method_9b6e(v0, v1[v2], var4_4, var2_2, 40);
        }
    }

    private static void method_9b6e(boolean bl, boolean bl2) {
        block8: {
            Command command;
            Canvas canvas;
            block9: {
    ...
    private static void update_cee2() {
        if (b != null) {
            a.removeCommand(b);
            b = null;
        }
    ...
    private static void method_9b6e(Graphics graphics, int n, int n2, int n3, int n4, int n5, int n6) {
        if (GameConfig.c) {
            int n7 = n5 >> 16;
            int n8 = n5 >> 8 & 0xFF;
            int n9 = n5 & 0xFF;
    ...
    private static Image loadIGPData(byte[] byArray, int n, int n2, int n3, int n4) {
        long l;
        int n5;
        int n6 = 0;
        ...
        System.gc();
        return GameController.method_9b6e(byArray, n, n2);
    }

    private static void method_9b6e(Graphics graphics, int n, int n2, int n3, int n4) {
        if (n3 > n4) {
            n3 = n4;
        }
        int n5 = (ak - n2) / 2;
    ...
    private static void loadIGPData(Graphics graphics, int n, int n2, int n3, int n4, int n5, int n6) {
        graphics.fillTriangle(n, n2, n3, n4, n5, n6);
    }

    private static void method_9b6e(Graphics graphics, Image image, int n, int n2, int n3, int n4, int n5, int n6) {
        graphics.drawRegion(image, n, n2, n3, n4, 0, n5, n6, 20);
    }

    private static void method_9b6e(Graphics graphics, Image image, int n, int n2, int n3) {
        int n4;
        int n5;
        int n6;
        Image image2;
    ...
    private static void loadIGPData(Graphics graphics, int n, int n2, int n3, int n4) {
        n = Math.max(n, 0);
        n2 = Math.max(n2, 0);
        n3 = Math.min(n3, ak);
        n4 = Math.min(n4, al);
    ...
    public static boolean method_9b6e(Graphics graphics, Image image, int n, int n2, int n3) {
        if (GameController.isOnline()) {
            return false;
        }
        if (!GameController.method_9b6e() || image == null || graphics == null) {
            return false;
        }
        ...
        if (j) {
            GameController.method_9b6e(graphics, image, n, n2, n3);
            return true;
        }
        return true;
    }
    ...
    public final void onCommand(Command command, Displayable displayable) {
        if (k) {
            if (command == a) {
                GameController.method_9b6e(25);
                return;
            }
            if (command == b) {
                GameController.method_9b6e(26);
            }
        }
    }

    private static final void update_6fca() {
    ...
    private static final String method_9b6e(String string) {
        if (GameConfig.i) {
