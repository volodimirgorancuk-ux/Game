...
public final class GraphicsEngine {
    ...
    public final void a(int n, byte[] byArray) {
        int n2;
        this.d |= 1 << n;
        if (byArray == null) {
            return;
    ...
    public final void a(int[] nArray, int n, int n2, int n3, int n4, int n5) {
        m = 102400;
    ...
    public final void a(int[] nArray, int n, int n2, int n3, int n4) {
        m = 0x1900000;
    ...
    public final void b(int[] nArray, int n, int n2, int n3, int n4, int n5) {
        m = 102400;
        GraphicsEngine.n = 102400;
        o = -102400;
        p = -102400;
        l = 1;
        this.b(n, n2, n3, n4, n5);
        l = 0;
        nArray[0] = m;
        nArray[1] = GraphicsEngine.n;
        nArray[2] = o;
    ...
    public final void b(int[] nArray, int n, int n2, int n3, int n4) {
        m = 102400;
        GraphicsEngine.n = 102400;
        o = -102400;
        p = -102400;
    ...
    public final void c(int[] nArray, int n, int n2, int n3, int n4, int n5) {
        this.a(nArray, n, n2, n3, n4, n5);
    }

    public final void c(int[] nArray, int n, int n2, int n3, int n4) {
        this.a(nArray, n, n2, n3, n4);
    }
     ...
     */
    public final void a(int var1_1, int var2_2, int var3_3, int var4_4, int var5_5) {
        block5: {
            block3: {
                block4: {
...
lbl18:
        ...
        if ((GameCanvas.ag & 32) != 0) {
            GameCanvas.a(this, var7_7, var3_3, var4_4, var5_5 ^ this.h[var6_6] & 15);
            return;
        }
        this.a(var7_7, var3_3, var4_4, var5_5 ^ this.h[var6_6] & 15);
    }
    ...
    public final void b(int n, int n2, int n3, int n4, int n5) {
        ...
        if ((n7 & 0x10) != 0) {
            this.a(n6, n3, n4, n5 ^ n7 & 0xF);
            return;
        }
        this.b(n6, n3, n4, n5 ^ n7 & 0xF);
    }
    ...
    public final void b(int n, int n2, int n3, int n4) {
        ...
        if (this.k[n] != 0) {
            ...
            if (this.k[n] != 1) {
                if ((GameCanvas.ag & 0x40) != 0) {
                    GameCanvas.b(a, this.e[n], n2, n3, n6, n5);
            ...
            if ((GameCanvas.ag & 4) != 0) {
                GameCanvas.a(a, this.e[n], n2, n3, n6, n5);
            }
            return;
        }
        Image image = null;
        ...
        if ((this.d[this.i] & 2) != 0) {
            ...
            if ((n14 & 1) != 0) {
                ...
                int n15 = GameCanvas.b();
                n6 = n6 * n15 / 100;
                n5 = n5 * n15 / 100;
            }
            if ((n14 & 2) != 0) {
                nArray = GameCanvas.b(nArray, n6, n5);
                this.a = true;
            }
        }
        if (image == null && nArray == null) {
            int[] nArray2 = this.a(n);
            if (nArray2 == null) {
                return;
            }
        ...
        if (l == 0) {
            if (image != null) {
                ...
                if ((GameCanvas.ag & 0x80) != 0) {
                    GameCanvas.a(a, nArray, n6, n5, n2, n3);
                } else if ((GameCanvas.ag & 0x18) != 0) {
                    try {
                        GameCanvas.a(a, n2, n3, nArray, n6, n5, n4);
                    }
                    catch (Exception exception) {}
                } else {
                    nArray = GameCanvas.a(a, nArray, n2, n3, n6, n5, n4, this.a);
                }
            }
        }
        if ((this.d[this.i] & 4) != 0 && (GameCanvas.ag & 4) != 0) {
            ...
            GameCanvas.a(a, n2, n3, nArray, n6, n5);
        }
    }
