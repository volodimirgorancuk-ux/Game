...
CommandListener {
    ...
    private static Image a(byte[] byArray) {
        int n = GameController.a(byArray);
        Image image = GameController.a(byArray, y, n);
        y += n;
        return image;
    }
    ...
    private static void a(int n, Graphics graphics, int n2, int n3, int n4) {
        GameController.a(GameController.a(n), graphics, ak, n2, n3, n4);
    }

    private static void a(String string, Graphics graphics, int n, int n2, int n3, int n4) {
        GameController.a(string, graphics, n2, n3, n4);
    }
    ...
    private static void a(String var0, Graphics var1_1, int var2_2, int var3_3, int var4_4) {
        block17: {
                    ...
                    block18: {
                        ...
                        for (var8_11 = 0; var8_11 < var11_9; ++var8_11) {
                            ...
                            if (var7_12 == '\n' && var6_6 < 10 || var7_12 == '\\' && var5_5.charAt(++var8_11) == 'N') {
                                ...
                                v2 = v4;
                                v1 = GameController.b;
                                v3 = GameController.b[v4] + (GameController.a(var7_12, GameController.C) + -1);
                            }
                            v1[v2] = v3;
                        }
                        v5 = var6_6;
            ...
            var9_7 = true;
            var10_8 = false;
            GameController.b(var1_1, 0, 0, GameController.ak, GameController.al);
            for (var8_11 = 0; var8_11 < var11_9; ++var8_11) {
                block21: {
                    block24: {
                        block23: {
                ...
                if (var14_14 == ' ') {
                    var13_13 -= GameController.a(var14_14, GameController.C) + -1 >> 1;
                }
                if (var7_12 == ' ') {
                    v10 = var13_13;
                    v11 = GameController.a(var7_12, GameController.C) + -1 >> 1;
                } else lbl-1000:
                // 2 sources

                {
                    GameController.b(var1_1, var13_13, var3_3, GameController.a(var7_12, GameController.C), GameController.a(var7_12, GameController.D));
                    GameController.a(var1_1, GameController.a[GameController.E], GameController.a(var7_12, GameController.A), GameController.a(var7_12, GameController.B), GameController.a(var7_12, GameController.C), GameController.a(var7_12, GameController.D), var13_13, var3_3);
                    v10 = var13_13;
                    v11 = GameController.a(var7_12, GameController.C) + -1;
                }
                var13_13 = v10 + v11;
            }
            GameController.b(var1_1, 0, 0, GameController.ak, GameController.al);
    ...
    public static void a(MIDlet mIDlet, Canvas canvas, int n, int n2) {
        GameController.a(mIDlet, canvas, n, n2, null);
    }
    ...
    private static void a(int n, String string, int n2, String string2, String string3) {
        try {
            String string4 = null;
            string4 = e ? GameController.a(GameController.a(string2), string, string3) : GameController.a("URL-" + string);
            boolean bl = GameController.a(string4, n2);
    ...
    private static void a(int var0, String[] var1_1, int var2_2, String var3_3) {
        ...
        if (GameController.e) {
            try {
                var3_3 = GameController.a(var3_3);
                if (var0 != 2) {
                ...
                block16: {
                    block14: {
                        ...
                        if (GameController.j.length() > 0) {
                            v2 = GameController.a(GameController.a("IGP-CATEGORIES"), var1_1[var7_7], GameController.j + "&ctg=XXXX");
                        }
                        break block16;
                    }
                    if (GameController.e) {
                        v2 = var1_1[var7_7].compareTo("GLDT") == 0 ? GameController.a(var3_3, var1_1[var7_7], GameController.e) : (var1_1[var7_7].compareTo("CATALOG") == 0 ? GameController.j : GameController.a(var3_3, var1_1[var7_7], var6_6));
                    } else {
                        v1 = GameController.b[var0] + "-" + var1_1[var7_7];
lbl35:
                        // 2 sources

                        v2 = var8_8 = GameController.a(v1);
                    }
                }
                if (!GameController.a(var8_8, 7)) continue;
    ...
    private static String[] a(byte[] byArray) {
        String[] stringArray = new String[GameController.a(byArray)];
    ...
    private static void b() {
                ...
                block58: {
                    block50: {
                        ...
                        try {
                            ...
                            byte[] byArray = GameController.a(0);
                            GameController.a(byArray);
                            a = GameController.a(byArray);
                            stringArray = GameController.a(byArray);
                            c = GameController.a(byArray);
                            d = GameController.a(byArray);
                            e = GameController.a(byArray);
                            a = GameController.a(byArray) == 1;
                            b = GameController.a(byArray) == 1;
                            try {
                                n = GameController.a(byArray);
                        ...
                        if (GameConfig.j) {
                            ...
                            try {
                                String string = GameController.a("URL-ORANGE");
                        ...
                        try {
                            e = GameController.a("URL-TEMPLATE-GAME").trim();
                            e = true;
                        }
                        catch (Exception exception) {}
                        for (int i = 0; i < H; ++i) {
                            GameController.a(i, stringArray[i], 7, "IGP-PROMOS", e);
                        }
                        String string = null;
                        try {
                            string = GameController.a("URL-OPERATOR");
                            if (GameController.a(string, 7)) {
                                j = string;
                            }
                            String string2 = GameController.a("URL-PT");
                            n = 0;
                            int n4 = 0;
                            ...
                            if (h != null && !GameController.a(h = h.toUpperCase(), 7)) {
                                h = null;
                            }
                        }
                        catch (Exception exception) {}
                    ...
                    if (!c) {
                        if (e) {
                            if (GameController.a(j, 7)) {
                                GameController.a(H, "PROMO", 7, "IGP-CATEGORIES", j + "&ctg=XXXX");
                            }
                        } else {
                            String string = GameController.a("URL-PROMO");
                            if (string != null) {
                                string.trim();
                                if (GameController.a(GameController.a("URL-PROMO"), 7)) {
                    ...
                    GameController.a(0, c, t, "IGP-WN");
                    GameController.a(1, d, u, "IGP-BS");
                    if (c) break block57;
                    if (!e) break block58;
                    if (!GameController.a(GameController.a(GameController.a("IGP-CATEGORIES"), "OP", j), 7)) break block57;
                    GameController.g[6] = j;
                    if (!GameController.a(j, 7)) break block57;
                    break block59;
                }
                if (!GameController.a(j, 7)) break block57;
                GameController.g[6] = j;
        ...
        try {
            ...
            k = null;
            if (!e) {
                string = GameController.a("URL-GLIVE").trim();
            } else if (GameController.a(j, 7)) {
                string = k = GameController.a(GameController.a("IGP-CATEGORIES"), "GLIVE", j + "&ctg=XXXX");
            }
            if (GameController.a(k, 7) && b) {
    ...
    public static int a() {
        ...
        if (a[8]) {
            if (GameController.b() > 1) {
                return 2;
            }
            return 1;
        }
        if (GameController.b() > 0) {
            return 0;
        }
        return -1;
    }
    ...
    private static void a(int n) {
        ...
        switch (n2) {
            ...
            case 1: {
                int n5;
                int n6;
                byArray = GameController.a(n3);
                for (n6 = 0; n6 < aj; ++n6) {
                    n5 = GameController.a(byArray);
                    y += n5;
                }
                GameController.a(byArray);
                n5 = GameController.a(byArray);
                ...
                if (!k) break;
                a = new Command(GameController.a(j), 4, 1);
                b = new Command(GameController.a(k), 2, 1);
                GameController.a(true, true);
                return;
            }
            case 2: {
                Image image;
                ...
                a = new Image[2];
                byArray = GameController.a(n3);
                int n12 = GameController.a(byArray);
                y = 0;
                GameController.a[0] = GameController.a(byArray);
                if (GameConfig.b) {
                    imageArray = a;
                    n11 = 1;
                    image = GameController.b(byArray, 2, n12, 1, 0xFF0000);
                } else {
                    imageArray = a;
                    n11 = 1;
                    image = a[0];
                ...
                int n13 = GameController.a(byArray);
                int n14 = GameController.a(byArray);
                a = new byte[(n14 + 1) * (4 + ap)];
                int n15 = n13 / (6 + ap);
                for (int i = 0; i < n15; ++i) {
                    int n16 = GameController.a(byArray);
            ...
            case 3: {
                ...
                for (int i = 0; i < w; ++i) {
                    ...
                    GameController.b[i] = GameController.a(byArray);
                }
                if (c == null) break;
    ...
    private static void a(int var0, int var1_1, int var2_2) {
        ...
        switch (var0) {
            ...
            case 6: {
                v0 = GameController.c;
                v1 = var2_2;
                v2 = GameController.a(GameController.a(var1_1));
                ** GOTO lbl59
            }
            case 5: {
                var3_3 = GameController.a(var1_1);
                GameController.e = GameController.a(var3_3);
                return;
            }
            case 7: {
            ...
            case 8: {
                ...
                for (var6_6 = 0; var6_6 < var5_5; ++var6_6) {
                    GameController.a[var4_4][var6_6] = GameController.a(var3_3);
                }
            ...
            case 10: {
                ...
                var3_3 = GameController.a(var7_7);
                GameController.c[var2_2] = GameController.a(var3_3);
                GameController.d = GameController.a(var3_3);
                return;
            }
            case 11: {
                var7_8 = GameController.x - 1 - (GameController.a != false ? 2 : 1);
                var3_3 = GameController.a(var7_8);
                GameController.a = GameController.a(var3_3);
                var3_3 = GameController.a(4 + GameController.H);
                v0 = GameController.c;
                v1 = 8;
                v3 = var3_3;
                v4 = 2;
...
lbl58:
                ...
                v2 = GameController.a(v3, v4, v5, v6, v7);
lbl59:
                // 3 sources
    ...
    private static Image a(byte[] byArray, int n, int n2, int n3, int n4) {
        ...
        n5 = GameController.a(byArray, n, n2, "PLTE");
        int n7 = GameController.a(byArray, n, n2, "tRNS");
        Image image = null;
        if (n5 > 0 && n7 > 0) {
            long l;
            int n8;
            ...
            for (n11 = 0; n11 < n12 / 3; ++n11) {
                ...
                nArray[n6] = n11;
                n10 = GameController.a(byArray, n5 + 4 + 3 * n11, 3);
                GameController.a(byArray, n5 + 4 + 3 * n11, 3, n4);
                nArray2[n6] = n10;
                ++n6;
            }
            ...
            n9 = GameController.a(byArray, n5 + 4 + n12, 4);
            GameController.a(byArray, n5 + 4 + n12, 4, (int)(l ^= 0xFFFFFFFFL));
            System.gc();
            if (GameConfig.d) {
            ...
            for (int i = 0; i < n6; ++i) {
                int n13 = nArray[i];
                int n14 = nArray2[i];
                GameController.a(byArray, n5 + 4 + 3 * n13, 3, n14);
            }
            GameController.a(byArray, n5 + 4 + n12, 4, n9);
        }
        return image;
    }
        ...
        switch (GameController.M) {
            case 0: {
                if (GameController.Q >= GameController.R) {
                    ...
                    GameController.a(GameConfig.b != 0 && GameController.Q == 6 ? GameController.I + 5 - 1 : GameController.Q);
                }
                ++GameController.Q;
                break;
            }
...
lbl85:
            ...
            case 2: {
                ...
                GameController.a(GameController.Q);
    ...
    public static void a(Graphics var0) {
        ...
        var1_1 = var0;
        GameController.b(var0, 0, 0, GameController.ak, GameController.al);
        GameController.b(var1_1, 0, 0, GameController.ak, GameController.al);
        switch (GameController.M) {
            case 0: {
                var0.setColor(0);
                var0.fillRect(0, 0, GameController.ak, GameController.al);
                GameController.a(var0, GameController.an, GameController.ak * 3 / 4, GameController.Q, GameController.R);
            ...
            case 1: {
                ...
                if (GameController.O == 8) {
                    ...
                    GameController.a(var1_1, 0, 0, GameController.ak, GameController.al, var2_2, var3_3);
                }
                GameController.d(var1_1);
                if (!GameController.o) ** GOTO lbl47
                GameController.b(var1_1);
                ** GOTO lbl176
lbl47:
                // 1 sources
                ...
                GameController.a(v1, v2, v3, v4, v5);
                GameController.d = true;
                GameController.a(GameController.f, null, 0, 0, 0);
                ...
                v7 = GameController.a(GameController.g);
                v8 = var1_1;
...
lbl80:
                ...
                GameController.a(GameController.a(GameController.f), var1_1, GameController.ak - (GameController.b[4].getWidth() + 8) * 2, GameController.b[4].getWidth() + 8, GameController.c[GameController.O].getHeight() + var8_9, 20);
                GameController.ai = GameController.c[GameController.O].getHeight() + var8_9 + GameController.F + GameController.ag / 2 + var8_9;
                GameController.a(var1_1, GameController.c[GameController.O], GameController.am, 2, 17);
                ** GOTO lbl176
lbl84:
                // 1 sources
                ...
                if (var4_4 != 0) {
                    GameController.a(var1_1, GameController.b[10], GameController.am, GameController.c, 17);
                }
                var12_21 = var11_18 + var6_7;
                var12_21 = var5_6 != 0 ? var12_21 + GameController.e.getHeight() / 2 : GameController.al / 2;
                GameController.a(var1_1, GameController.e, GameController.am - 1, var12_21, 3);
                GameController.a(GameController.a(GameController.ad), var1_1, GameController.e.getWidth() * 9 / 20, GameController.am + 2, var12_21, 3);
...
lbl111:
                ...
                if (GameController.O == 6) {
                    ...
                    GameController.a(var1_1, GameController.c[GameController.O], GameController.am, var10_15, 3);
                    var11_19 = GameController.E;
                    GameController.E = 1;
                    GameController.a(GameController.a(GameController.ad), var1_1, GameController.c[GameController.O].getWidth() / 2, GameController.am, var10_15, 3);
                    ...
                    if (GameController.O == 8) {
                        ...
                        var6_7 = 0;
                        GameController.d = true;
                        GameController.a(GameController.a(GameController.p), var1_1, GameController.ak - 50, GameController.am, 0, 17);
                        var7_8 = GameController.F;
                        GameController.d = true;
                        GameController.a(GameController.a(GameController.q), var1_1, GameController.ak - 50, GameController.am, 0, 17);
                        var8_9 = GameController.F;
                        var9_12 = GameController.al - var4_4 - GameController.ag - var7_8 - var8_9 - var5_6;
                        var10_16 = var9_12 / 6;
                        GameController.a(var1_1, GameController.a, GameController.am, 0, 17);
                        var6_7 = 0 + (var4_4 + var10_16);
                        GameController.E = 0;
                        GameController.a(GameController.a(GameController.p), var1_1, GameController.ak * 3 / 4, GameController.am, var6_7, 17);
                        GameController.a(var1_1, GameController.c[8], GameController.am - 1, var6_7 += var7_8 + var10_16, 17);
                        GameController.a(GameController.a(GameController.r), var1_1, GameController.ak * 3 / 4, GameController.am, var6_7 + var5_6 / 2, 3);
                        v7 = GameController.a(GameController.q);
                        v8 = var1_1;
                        ...
                        var10_17 = var8_9;
                        GameController.a(var1_1, GameController.c[GameController.O], GameController.am, var10_17, 17);
                        ...
                        v7 = GameController.a(GameController.ad);
                        v8 = var1_1;
                        v9 = var11_20;
                        v10 = GameController.am;
                        v12 = var9_13;
...
lbl174:
                    ...
                    GameController.a(v7, v8, v9, v10, v11, v14);
                }
lbl176:
                // 5 sources
                ...
                if (GameController.ac > 1) {
                    ...
                    GameController.a(var1_1, GameController.b[var5_6], 1 + var4_4, GameController.an, 6);
                    if (!GameConfig.h && !GameConfig.k) {
                        GameController.a(var1_1, GameController.b[var7_8], 1 + var4_4 + GameController.J, GameController.an, 6);
                    }
                    GameController.a(var1_1, GameController.b[var6_7], GameController.ak - 1 - var4_4, GameController.an, 10);
                    if (!GameConfig.h && !GameConfig.k) {
                        GameController.a(var1_1, GameController.b[var8_9], GameController.ak - 1 - var4_4 - (GameController.b[var6_7].getWidth() - GameController.b[var8_9].getWidth()) + GameController.K, GameController.an, 10);
                    }
            ...
            case 3: {
                GameController.a(var0, 0, 0, GameController.ak, GameController.al, 201756, 35031);
                GameController.a(GameController.s, var0, GameController.am, GameController.an, 33);
                GameController.d(var0);
            }
        }
    }
    ...
    private static void b(Graphics graphics) {
        ...
        int n5 = c;
        if (al > 128) {
            GameController.a(graphics, c[O], am, c, 17);
            n5 += c[O].getHeight();
        }
        int n6 = n5;
        E = 1;
        GameController.a(ad, graphics, am, n6, 17);
        int n7 = Math.max(2 * z, a[S][a[S][0]].getHeight());
        d = true;
        GameController.a(ad, null, 0, 0, 0);
        int n8 = n6 + F;
        int n9 = n4 = al * 5 / 100;
        int n10 = (al / 2 - n8) * 2;
        ...
        if (U < T) {
            if (V > 0) {
                GameController.a(graphics, am, n12 - n9, n4, 65535, true, false);
            }
            if (V + U < T) {
                GameController.a(graphics, am, n12 + U * n7 + n9, n4, 65535, true, true);
            }
        }
        n12 = n8 + n7 / 2 + 1;
        ...
        for (int i = V; i < V + U; ++i) {
            int n16 = a[S][i];
            GameController.a(graphics, a[S][n16], n13, n12, 6);
            if (S == 2 || n16 == b[S].length - 1) {
                E = 1;
            }
            GameController.a(GameController.a(b[S][n16]), graphics, n15, n12, 6);
            n12 += n7;
        }
        X = W - V;
        Y = n13 - 2;
    ...
    private static void a(Graphics graphics, int n, int n2, int n3, int n4, boolean bl, boolean bl2) {
        ...
        GameController.b(graphics3, n18, n17, n16, n15, n14, n13 + n12);
        ...
        GameController.b(graphics2, n11, n10, n9, n8, n7, n6 - n5);
    }
    ...
    private static void d() {
        GameController.d = true;
        GameController.a(GameController.ae, null, 0, 0, 3);
        var0 = GameController.a(32, GameController.C) / 2;
        var1_1 = GameController.a(32, GameController.D) / 3;
...
lbl16:
    ...
    private static void c(Graphics graphics) {
        if (n) {
            ...
            GameController.a(ae, graphics, am, ai + (ag >> 1), 3);
        }
    }
...
lbl-1000:
                        ...
                        GameController.a(var0, var5_5, var1_1, var2_2, 36);
                        GameController.a(var0, var6_6, GameController.ak - var1_1, var2_2, 40);
                    ...
                    if ((GameController.a & 1) != 0) {
                        GameController.a(var0, GameController.b[9], var3_3, var2_2, 36);
                    }
                ...
                if ((GameController.a & 2) != 0) {
                    GameController.a(var0, GameController.b[8], var3_3, var2_2, 36);
                }
            ...
            GameController.a(v0, v1[v2], var4_4, var2_2, 40);
        }
    }
    ...
    private static Image b(byte[] byArray, int n, int n2, int n3, int n4) {
        ...
        System.gc();
        return GameController.a(byArray, n, n2);
    }
    ...
    public static boolean a(Graphics graphics, Image image, int n, int n2, int n3) {
        ...
        if (!GameController.a() || image == null || graphics == null) {
            return false;
        }
        ...
        if (j) {
            GameController.a(graphics, image, n, n2, n3);
            return true;
        }
        return true;
    }
